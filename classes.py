...
class Earphone:
    def __init__(self, name: str, freqmax: int, freqmin: int, sensbase: float, sensvar: float, impbase: float, impvar: float, drivers: str, price: float):
        self.name = name
...
class Bluetooth:
    def __init__(self, name: str, bluetoothversion: float, anc: bool, maximumdistance: int, batterylife: int, earphonebatterycapacity: int, casebatterycapacity: int, price: float):
        self.name = name
...
class Dac:
    def __init__(self, name: str, minimumfrequency: float, maximumfrequency: float, minimumimpedance: float, maximumimpedance: float, inputport: str, outputport: str, amplifierchip: bool, decodingchip: bool, price: float):
        self.name = name
